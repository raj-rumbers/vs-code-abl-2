# Choose Project for 'check syntax'
...
Decision: Option B — Log to Output panel only

When auto-detection overrides the default project:

Log informational message in Output panel.
...
Transparent but non-disruptive.

Developers can inspect logs if needed.

---

Q2: User Control and Configuration

Decision: Option A — No additional configuration setting

Auto-detection SHALL always be active.

No abl.autoDetectProject setting will be introduced.
...
Decision: Option A — Longest matching root wins

When multiple projects match:

Select project with longest matching root path.

Default project does NOT influence nested resolution.
...
Q4: Invalid or Inaccessible Project Roots

Decision: Option C — Graceful degradation
...
Log warning in Output panel.

Skip project in detection logic.
...
Decision: Option A — Apply consistently across all project-dependent commands

Project resolution logic SHALL be:

Extracted into reusable utility.
...
any future project-based commands
